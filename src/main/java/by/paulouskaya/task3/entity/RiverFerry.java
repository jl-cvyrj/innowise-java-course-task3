...
public class RiverFerry {
  ...
  private boolean isOnTrip = false;
    ...
    logger.info("Car {} loaded on ferry. Current weight: {}/{}, area: {}/{}", car.getCarId(), currentWeight, maxWeight, currentArea, maxArea);
    ...
    isOnTrip = true;
    logger.info("Ferry starting trip with {} cars. Weight: {}/{}, Area: {}/{}", getLoadedCarsCount(), currentWeight, maxWeight, currentArea, maxArea);
